...
def get_arguments():
    ...
    # DoRA arguments
    parser.add_argument('--W_decompose', default=False, action='store_true', help='whether to tune only the magnitude component of Wdecompose or not')
    parser.add_argument('--dora_simple', default=True, action='store_false', help='whether to use dora simple to save up GPU memory')
    # ortho loss
    parser.add_argument('--ortho_loss_weight', default=0.1, type=float, help='weight of the ortho loss')
