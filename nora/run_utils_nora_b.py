...
def get_arguments():
    ...
    # UoRA_B arguments
    parser.add_argument('--init_method', type=str, default='1', choices=['1', '2', '3', '4'], help='choose the initialization method for W_A and W_B')
    parser.add_argument('--structure', type=str, default='1', choices=['1', '2', '3', '4'], help='choose the structure for W_a and W_b')
